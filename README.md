...
**ranola** is built on top of [**scala breeze**][2] and utilizes big part of its resources. **ranola** supports both dense (DenseMatrix[V]) and sparse types (CSCMatrix[V]) of matrices that are reprsesnted in [**scala breeze**][2].
